 ...
 */
?>
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix post_row"<?php print $attributes; ?>>
  <div class="post">
			<?php if($blog_image):?>
			<div class="img">
			...
			<div class="text">
				...
				<span class="date"><?php if($blog_submitted) print $blog_submitted; ?></span>
				<p><?php print $blog_body; ?></p>
			</div>
